                ...
                <div className="flex flex-col md:flex-row items-center gap-8">
                    ...
                    >
                        ...
                        <motion.div variants={item} className="flex gap-2.5">
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="mt-4 bg-orange-500 hover:bg-orange-600 text-white font-semibold px-8 py-3 rounded-lg"
                            >
                                Book a Table
                            </motion.button>
                            ...
                            <motion.button
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="mt-4 bg-black hover:bg-orange-600 text-white font-semibold px-8 py-3 rounded-lg"
                            >
                                Contact Us
                            </motion.button>
                    ...
                    >
                        ...
                        <div className="relative">
                            ...
                            <div className="absolute -z-10 top-5 left-5 w-full h-full rounded-2xl"></div>
                        </div>
